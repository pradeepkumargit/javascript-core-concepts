...
var person = {
    ...
    printActions:function() {
    	...
    	this.actions.forEach(function(action) {
    		var str = _this.first + ' liks to do '+ action;
    		console.log(str);
    	});
    }
    ...
    // printActions:function() {				
    // 	this.actions.forEach(function(action) {
    // 		var str = this.first + ' liks to do '+ action;
    // 		console.log(str);
    // 	}.bind(this));
    // }
...
//3. Copying Arrays
//Getting a copy of an array is a frequent tasks, something  we've used Array.prototype.slice to do in the past, .
...
// INTERVIW QUESTIONS ES6
//1.
//http://www.punch.cool/community/questions-answers/engineering/ecmascript6/
